...
const TelaConversor = document.querySelector('.TelaAppCoverter');
const BtAbrirConversor = document.getElementById("btAbrirConversor");


BtAbrirConversor.addEventListener("click", ()=> AbrindoConversor());


const AbrindoConversor =() =>{

    TelaConversor.style.display = "block";
